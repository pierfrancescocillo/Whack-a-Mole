    ...
    if(boolClick != 0){
      ...
      if(keyCode == 65){ //A
        if(c*Math.PI/2 < Math.PI/2){ //--> c < 1
          ...
          //hamm_world = utils.multiplyMatrices(m4.translation(-(molePos[0][0] - hamm_initPos[0])*c/2,-(molePos[0][1] - hamm_initPos[1] + 0.8)*c/2,-(molePos[0][2] - hamm_initPos[2])*c/2),m4.translation((molePos[0][0] - hamm_initPos[0]),(molePos[0][1] - hamm_initPos[1] + 0.8),(molePos[0][2] - hamm_initPos[2])));
        }
