...
function vec2v( x = 0, y = 0 )               {  return [ x, y       ];  }

function vec3v( x = 0, y = 0, z = 0 )        {  return [ x, y, z    ];  }

function vec4v( x = 0, y = 0, z = 0, w = 1 ) {  return [ x, y, z, w ]; }
...
function mat4()
{
    ...
    case 1:
        m = [
            vec4v( v[0], 0.0,  0.0,   0.0 ),
            vec4v( 0.0,  v[0], 0.0,   0.0 ),
            vec4v( 0.0,  0.0,  v[0],  0.0 ),
            vec4v( 0.0,  0.0,  0.0,  v[0] )
        ];
        break;
